        ...
        for(n = 0; n < SMAX; ++n)
        {
            ...
            for(m = 0; m < SMAX; ++m){
                ...
                for(k = 0; k < SMAX; ++k){
                    ...
                    B.z() += (wz * mesh.fieldB(indx,indy,indz,2) );
                }
            }
        }
        h = unit(B);
        ...
        for(n = 0; n < SMAX; ++n)
        {
            ...
            for(m = 0; m < SMAX; ++m){
                ...
                for(k = 0; k < SMAX; ++k){
                    ...
                    wx = sx05[n] * sy0[m] * sz0[k];
                    wy = sx0[n] * sy05[m] * sz0[k];
                    wz = sx0[n] * sy0[m] * sz05[k];
                    ...
                    for(n1 = 0; n1 < SMAX; ++n1){
                        ...
                        for(m1 = 0; m1 < SMAX; ++m1){
                            indy1 = yk + m1;
                            for(k1 = 0; k1 < SMAX; ++k1){
                                wx1 = sx05[n1] * sy0[m1] * sz0[k1];
                                wy1 = sx0[n1] * sy05[m1] * sz0[k1];
                                wz1 = sx0[n1] * sy0[m1] * sz05[k1];
