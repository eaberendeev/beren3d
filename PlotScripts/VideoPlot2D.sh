...
i = 250 #len(Files)-1 #-rank #StartNum+  rank
print(i,Files)
...
stepX = "591"
while i >=0:
	TimeStep=str(i).zfill(3) #Files[i][-FileNameSignNum:]
...
#
		...
		FieldDataXY=ReadFieldsFile2D(WorkDir,"PlaneZ_"+step+"_","xy",SystemParameters,TimeStep)
